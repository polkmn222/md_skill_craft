...
### Mode 1: Generate Project Configuration (Interactive)
```
md-skill-craft > (press enter or describe project)

[Describe your project in a few sentences]

[LLM analyzes and generates CLAUDE.md / AGENT.md / GEMINI.md]
...
[LLM scans project and validates existing CLAUDE.md]

Shows issues and improvement suggestions
```
...
- Use `match` statements (Python 3.11+) for dispatch
...
- `anthropic`, `openai`, `google-genai` — LLM APIs
